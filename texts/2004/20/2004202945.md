...
```
  ...
  Analyse chimique                            bulletin en annexe
  Materiel de plantation                      passeport(s) phytosanitaire(s)
...
```
  N° parcelle      Variete     Stade eclatement     Floraison
                                du bourgeon         Debut    Pleine    Fin
...
```
  N° parcelle    Date   Fumure au     Apports     Dose/ha      Remarques
                         sol du        foliaires
                         bourgeon
...
```
  N° parcelle    Date   Nom           Matiere     Quantite     Justification
                         commercial    active      pc/ha*       et remarques
                                       et %
...
```
  N° parcelle    Date   Nom           Matiere     Quantite     Justification,
                         commercial    active      pc/ha        conditions
                                       et %        *            et remarques
...
```
  N° parcelle    Date   Appareil ou methode    Justification, conditions et
                                                remarques
...
```
  N° parcelle    Date   Nom           Matieres    Quantite     Justification,
                         commercial    actives*    pc/ha        conditions,
                                       et %                     stade* *
                                                                et remarques
...
```
  N° parcelle    Date   Mode observation +   Resultats des       Decision
                         partie ou stade      comptages
...
```
  N° parcelle    Variete   Passage de  Date de     Poids     Frigo  Vente
   (1)            (1)       cueillette  cueillette  total     (4)    prevue
                            (2)                     et               (5)
                                                    nbre
                                                    palox
                                                    (3)
...
```
  N°        Nbre       Date       Conditionnement *    Destination Date
   parcelle  de palox   triage    type  poids   nombre              livraison
             et
             variete
...
```
  RAVAGEURS                    avril  mai  juin  juillet  aout       Recolte
