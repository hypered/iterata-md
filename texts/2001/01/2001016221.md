...
```
  ...
  - le fecondant specifie ou l'un des fecondants etant                  600 m
  ...
  - le fecondant specifie etant exclusivement tetraploide,              600 m
   ...
   sucriere diploide;
  - par rapport aux sources de pollen de betterave                      600 m
   sucriere dont la ploidie est inconnue;
  - le fecondant specifie ou l'un des fecondants etant                  300 m
   diploide, par rapport aux sources polliniques de
   betterave sucriere diploide;
  - le fecondant specifie etant exclusivement tetraploide,              300 m
   par rapport aux sources polliniques de betterave
   sucriere tetraploide;
  - entre deux champs de production de semences de                      300 m
  ...
  - le fecondant specifie etant exclusivement tetraploide,              600 m
   par rapport aux sources polliniques de betterave
   fourragere diploide;
  - par rapport aux sources polliniques de betterave                    600 m
...
```
      a)               Purete minimale        Faculte         Taux maximal
                      specifique (% du      germinative     d'humidite (% du
                         poids) (1)       minimale (% des      poids) (1)
                                           glomerules ou
                                          semences pures)
  aa) Betteraves
   sucrieres
