...
title-fr: "Arrêté du Gouvernement flamand visant à compenser l'obligation de service public pour le transport des personnes handicapées ou à mobilité très réduite(NOTE : Consultation des versions antérieures à partir du 04-11-2013 et mise à jour au 27-03-2023)"
date: 2013-10-11
...
Jusqu'à 25 km, la compensation se monte à :

1. 1,50 euros par kilomètre parcouru si seul un utilisateur en chaise roulante est transporté;

2. 3 euros par kilomètre parcouru si plusieurs utilisateurs en chaise roulante sont transportés, quel que soit le nombre d'utilisateurs qui ne sont pas en chaise roulante;

3. 50 centimes d'euro par kilomètre parcouru si seul un utilisateur qui n'est pas en chaise roulante est transporté;

4. 1 euro par kilomètre parcouru si plusieurs utilisateurs qui ne sont pas en chaise roulante sont transportés;

5. 2 euros par kilomètre parcouru si un utilisateur en chaise roulante et un ou plusieurs utilisateurs sans chaise roulante sont transportés.

A partir de 26 km et jusqu'à 50 km, la compensation se monte à :

1. 75 centimes d'euro par kilomètre parcouru si seul un utilisateur en chaise roulante est transporté;

2. 1,50 euro par kilomètre parcouru si plusieurs utilisateurs en chaise roulante sont transportés, quel que soit le nombre d'utilisateurs qui ne sont pas en chaise roulante;

3. 25 centimes d'euro par kilomètre parcouru si seul un utilisateur qui n'est pas en chaise roulante est transporté;

4. 50 centimes d'euro par kilomètre parcouru si plusieurs utilisateurs qui ne sont pas en chaise roulante sont transportés;

5. 1 euro par kilomètre parcouru si un utilisateur en chaise roulante et un ou plusieurs utilisateurs sans chaise roulante sont transportés.
