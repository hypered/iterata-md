...
```
  ...
  Semences de prebase (b)              1 000                  250
  Semence de base, semences              500                  250
  certifiees, R1, R2 (b)
  --------------------------------------------------------------------
```
...
```
  ...
  Semis apres le 30/04                            15 jours avant le semis
  Deuxieme recolte d'une même année de culture    15 jours apres la
                                                  premiere recolte de
                                                  semences
  -----------------------------------------------------------------------
```
...
```
  ...
  -----------------------------------------------------------------------
  Semences de pebase et     a + c           b + c              a + b
  de base
  Semences certifiees         a               b                  b
  -----------------------------------------------------------------------
```
...
```
  ...
  - parcelles plus grandes que 2 ha                          100 m
...
```
  ----------------------------------------------------------------------
      Especes         Type d'impurete     Nombre maximum de plantes par
                                          superficie de la catégorie a
                                                    produire
                                         -------------------------------
                                          Sem. de    Semences certifiees
                                         prebase et
                                          de base
  ----------------------------------------------------------------------
                           Impuretes varietales
  ----------------------------------------------------------------------
  Graminees (sauf                         1/30 m2          1/10 m2
  Poa pratensis)
  ----------------                       -------------------------------
  Poa pratensis                           1/20 m2          4/10 m2
  (sauf varietes
  apomictiques
  monoclonales)
  ----------------                       -------------------------------
  Poa pratensis      Plantes qui sont     1/20 m2          6/10 m2
  (monoclonale       manifestement non
  apomictische       conformes a la
  rassen)            variete concernee
  ----------------                       -------------------------------
  Legumineuses                            1/30 m2          1/10 m2
  (sauf Pisum
  sativum, Vicia
  faba)
  ----------------                       -------------------------------
  Autres especes                          1/30 m2          1/10 m2
  (sauf Brassica
  napus var.
  napobrassica,
  Brassica
  ...
  ----------------------------------------------------------------------
                           Impuretes d'especes
  ----------------------------------------------------------------------
  Lolium spp.        [Autre variete de    1/50 m2          1/10 m2
  x-Festulolium      Lolium spp. ou
                     x-Festulolium]
                     <Erratum,
                     M.B. 08-06-2002,
                     p. 26425>
  ----------------------------------------------------------------------
  Toutes especes     Avena fatua,         0                0
  (sauf Vicia spp.   Avena sterilis en
  en Pisum spp.)     Avena ludoviciana
  ----------------------------------------------------------------------
  Graminees          Alopecurus           1/50 m2          1/10 m2
                     myosuroides *
                     Agropyron
                     repens *
                     Vulpia spp. *
  ...
  (sauf Vicia spp.   ---------------------------------------------------
  et Pisum spp.)     Rumex sp. (sauf      1/50 m2          1/10 m2
                     acetosella en
                     maritimus) *
  ----------------------------------------------------------------------
```
...
```
  -------------------------------------------------------------------
    Plantes malades      Semences de prebase et   Semences certifiees
                                de base
  -------------------------------------------------------------------
  Anthracnose :
  - Pisum                10 pl/are                     20 pl/are
  - Vicia                 5 pl/are                     10 pl/are
  Plantes virosees (%)    5                            10
  -------------------------------------------------------------------
```
...
```
  -------------------------------------------------------------------------
         Espece            Poids max.    Poids min. d'un      Poids d'un
                          d'un lot (en    echantillon a    echantillon pour
...
```
  ----------------------------------------------------------------------
    Donnees a fournir                     CE-B                    CE-A
                           ---------------------------------------------
                            Semences     Semences    Melanges   Melanges
                           certifiees  commerciales    (a)        (a)
  ----------------------------------------------------------------------
  - " Petits emballages        -            -           -          x
      CE-A "
  - " Belgique "               -            -           -          x
  - Nom et adresse du          x            x           x          x
    fournisseur ou son
    numero d'agrement
  - Espece, indiquee au        x            x           -          -
    moins en caracteres
    latins (b)
  - Variete, indiquee au       x            -           -          -
    moins en caracteres
    latins
  - Categorie et classe        x            x           -          -
    (c)
  - Numero de reference        x            x           x          x
    du lot
  - " Melange pour ... "       -            -           x          x
    (utilisation prevue)
  - Poids net ou brut ou       x            x           x          x
    le nombre de graines
    pures ou glomerules
  - Nature des additifs        x            x           x          x
    ainsi que les
    proportions entre le
    poids des semences
    pures et le poids
    total (d)
  - Rapport des poids          -            -           x          x
