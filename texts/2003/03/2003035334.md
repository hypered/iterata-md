...
```
                Periode de     Valeur limite  Marge de       Date a laquelle
                 calcul de                     depassement    la valeur
                 la moyenne                                   limite doit
                                                              etre respectee
  Valeur        Annee civile   5 MUg/m3       2 MUg/m3 pour  1er janvier 2005
   limite                                      l'annee 2003
   ...
   sante
   humaine
  Valeur limite 24 heures      50 MUg/m3      aucune         aucune periode
   journaliere                  comme 98e                     transitoire
                                percentile
                                des moyennes
                                journalieres
                                au cours
...
```
                Periode de     Valeur limite  Marge de       Date a laquelle
                 ...
                 la moyenne                                   limite doit
                                                              etre respectee
  Valeur        Maximum        10 MUg/m3      4 MUg/m3 pour  1er janvier 2005
   limite pour   journalier de                 l'annee 2003
   la            la moyenne                   2 MUg/m3 pour
   protection    sur 8 heures                  l'annee 2004
   de la
   sante
   humaine
```
...
```
  ...
  Periode minimale prise en    90 %                     90 %
   compte                      35 % sites urbanises
                                et sites axes sur
                                la circulation
  ...
  Periode minimale prise en    14 % (une mesure d'un    14 % (une mesure
   compte                       jour par semaine, au     d'un jour par
                                hasard, egalement        semaine, au hasard,
                                repartie sur l'annee,    egalement repartie
                                ou 8 semaines egalement  sur l'annee, ou
