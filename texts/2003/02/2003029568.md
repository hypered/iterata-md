...
Nouveaux gradesAnciens grades

AgentGarcon de bureau
...
AttacheSecretaire d'administration

Attache principalConseiller adjoint

Conseiller Conseiller

Premier conseiller Premier conseiller

DirecteurDirecteur d'administration
...
A. Acces d'agents de l'UniversiteB. Admission au
...
GradesGrades dont les Conditions Diplomes ou

titulaires ontspecialescertificats

acces aux grades pris en

indiques a laconsideration

colonne 1.

1. AttacheTous les agents a) reussite d'un Diplome de

definitifs du concours deuxieme cycle

niveau 2d'accessionrepute par la

   b) annees loi ou le

d'anciennete audecret de

moins dans leniveau

niveau 2 universitaire.

2. AttacheAttache a) promotion
...
3. PremierAttache principal a) promotion
...
5. PremierConseillera) promotion
...
6. Directeura) Premiera) promotion
...
directeurb) quinze ans

Informaticien-d'anciennete

expertdans les grades
...
7. DirecteurDirecteur a) promotion
...
1. AgentAgent des six Changement dePas de diplome
...
2. Agent qualifie Agent qualifie desChangement deDiplome,
...
3. AgentAgent specialiseChangement deDiplome,

specialisedes six groupes groupe certificat ou
...
Agent qualifiea) avancement avec
...
4. Premier agentPremier agent Changement deDiplome de

specialisespecialise desgroupe l'enseignement

six groupessuperieur de

type court

Agent specialisea) avancement avec
...
5. Premier agentPremier agent Changement de

specialisespecialisegroupe
...
6. AgentAgent specialiseChangement de

specialiseen chef des groupe
...
7. Premier agentPremier agent Changement de
...
8. Premier agentPremier agent Changement de

specialise en specialise en groupe

chef principalchef principal
...
2. InfirmierInfirmier graduea) avancement
...
3. InfirmierInfirmier graduea) promotion

graduede 1re classeb) 3 ans

principal d'anciennete de

grade

4. Infirmier en Infirmier graduea) promotion

chefprincipalb) 3 ans

d'anciennete de

grade

5. InfirmierInfirmier en chef a) promotion
...
6. LogopedeDiplome de

logopede

7. Logopede deLogopedea) avancement

1re classesans examen
...
9. Logopede enLogopede principala) promotion
...
10. Logopede en Logopede en chefa) promotion
...
2. Architecte Architectea) promotion
...
3. Architecte Architectea) promotion
...
directeur principalb) 9 ans

d'anciennete dans

le niveau 1

5. ConducteurDiplome de
...
6. Conducteur Conducteura) avancement

principalb) ancienneté de

grade de 9 ans

7. Conducteur enConducteurpromotion
...
9. IngenieurIngenieur a) avancement sans

technicientechnicienexamen
...
chefprincipal d'anciennete de

grade

14. Ingenieur Ingenieur a) promotion

industriel en industriel enb) 9 ans

chef principalchefd'anciennete dans
...
de serviced'anciennete de

grade

18. Ingenieur enIngenieur a) promotion

chef-directeurprincipal-chef deb) 9 ans
...
19. Ingenieur-Ingenieur ena) promotion

inspecteurchef-directeur b) 3 ans
...
21. Assistant Assistant sociala) avancement sans
...
22. Assistant Assistant sociala) promotion

social principalde 1re classeb) 3 ans

d'anciennete de

grade

23. Assistant Assistant sociala) promotion

social en chefprincipalb) 3 ans

d'anciennete de

grade

24. Assistant Assistant sociala) promotion

social en chefen chefb) 3 ans

principal d'anciennete de

grade

25. Operateur-a) Agent affecte aa) epreuve de

mecanographeun centre dequalification

de 2e classetraitement de
...
mecanographemecanographeexamen
...
27. ChefOperateur-a) promotion

operateur-mecanographe deb) 9 ans

mecanographe1re classed'anciennete au

de 2e classemoins dans les
...
28. ChefChef operateur- a) avancement avec

operateur-mecanographeexamen

mecanographede 2e classe b) 6 ans
...
2e classeb) 3 ansd'enseignement

d'anciennete desuperieur de
...
32. Analyste de Chef-programmeura) promotion

programmationb) pas d'anciennete
