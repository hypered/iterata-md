...
Tcetant la temperature nominale de chaque

compartiment (en °C)

Vcetant le volume utile d'un type donne de
...
Cc = 1pour les appareils de refrigeration
...
Categorie DescriptionEmax (kWh/24 h)
...
Temperature duCategorieEmax (kWh/24 h)
