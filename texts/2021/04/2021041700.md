...
Les tests polygraphiques doivent être effectués avec un appareil qui recueille et enregistre au moins les données physiologiques suivantes :
   ...
   4) Mouvements : ceux-ci sont enregistrés par des capteurs qui sont liés à la chaise polygraphique. Cette dernière, statique ou mobile, doit également être équipée de capteurs de mouvement.
